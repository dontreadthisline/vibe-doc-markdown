...
| Under review | as submission   | to  | TMLR                                                                     |     |
| ------------ | --------------- | --- | ------------------------------------------------------------------------ | --- |
|              | General-Purpose |     | Daytona(DaytonaPlatforms,Inc.,2024),E2B(E2B,2024),Modal(ModalLabs,2024), |     |
Northflank(Northflank,2024),
|     | ManagedSandboxes    |     | OpenSandbox(Alibaba,2026),DockerSandboxes(Docker,Inc.,2025) |     |
| --- | ------------------- | --- | ----------------------------------------------------------- | --- |
...
OS-LevelPermission
|     | andRuntimeSecurity |     | IsolateGPT(Wuetal.,2025),AgentBound(Bühleretal.,2025), |     |
| --- | ------------------ | --- | ------------------------------------------------------ | --- |
...
| --- | ---------------------- | --- | -------------------------------------------------- | --- |
|     | Training,andEvaluation |     | SandMLE(Zhouetal.,2026),                           |     |
